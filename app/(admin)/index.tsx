...
export default function AdminDashboard() {
  const { transactions } = useDemoState();
...
const styles = StyleSheet.create({
  ...
  activityCard: { backgroundColor: colors.white, borderRadius: borderRadius.lg, overflow: 'hidden', shadowColor: colors.charcoal, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
